...
{
	public class SQLiteStorageLight : IStorage
	{
		...
		public SQLiteStorageLight(string _dbName)
		{
		...
		{
			private readonly SQLiteStorageLight m_storage;

			public Transaction(SQLiteStorageLight _storage)
			{
				m_storage = _storage;
