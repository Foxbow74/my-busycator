    ...
    class TheHallLayer:WorldLayer
    {
        ...
        protected override MapBlock GenerateBlock(Point _blockId)
        {
			...
			if (_blockId.Y == 0 && _blockId.X == 0)
            {
				...
				block.AddEssence(new IndoorLight(new LightSource(18, new FColor(1f, 0f, 1f, 1f)), EssenceHelper.GetFirstFoundedMaterial<MetalMaterial>()), new Point(2, 0));
				...
				//block.Map[0, 2] = ETerrains.STONE_WALL;
